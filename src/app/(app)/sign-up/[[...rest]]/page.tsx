...
export default function Page() {
    return (
        <div className="min-h-screen w-full lg:grid lg:grid-cols-2">
            ...
            <div className="hidden lg:flex relative flex-col justify-between p-12 bg-slate-950 text-white overflow-hidden isolate">
                ...
                <div className="relative z-10 max-w-lg">
                    <h1 className="text-4xl font-bold tracking-tight mb-4 text-white leading-tight">
                        ...
                        <span className="text-indigo-400">to content mastery.</span>
                    </h1>
                    <p className="text-lg text-slate-400 leading-relaxed">
                        Join the complete operating system for SaaS founders to build, manage, and dominate their SEO strategy at the speed of AI.
                    </p>
                </div>
            ...
            <div className="flex items-center justify-center p-6 lg:p-12 bg-white min-h-screen lg:h-full relative overflow-y-auto">
                <div className="w-full max-w-[440px] space-y-10 pt-24 lg:pt-0">
                    <SignUp
                        appearance={{
                            elements: {
                                rootBox: "w-full",
